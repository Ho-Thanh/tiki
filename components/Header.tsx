...
const Header = () => {
    const[items, setItems] = useState([
        ...
        {title: 'thịt', link:'https://tiki.vn/rau-cu-qua/c44816?src=featured_keywords'},
            ...
            <div className='items-center w-10/12 m-auto'>
                <div className='flex col-span-1 justify-items-center'>
                    ...
                    <a className='flex items-center'>
                        <img className="w-10 h-10 m-2"
                         ...
                         <div className='flex flex-col text-white '>
                             ...
                             <span className='flex'>
                                 Sản Phẩm
                                 <img src="https://salt.tikicdn.com/ts/upload/d7/d4/a8/34939af2da1ceeeae9f95b7485784233.png"
                                    className='w-8 h-7'></img>
                                 
                            </span>
                         </div>
                    </a> 
                    <div className='flex w-6/12 mx-4 my-5'>
                        <input data-view-id="main_search_form_input" type="text" 
                        placeholder="Tìm sản phẩm, danh mục hay thương hiệu mong muốn ..." 
                        className="w-10/12 h-10 rounded-l-md" value=""/>
                        <button data-view-id="main_search_form_button" className="flex h-10 text-white bg-blue-900 w-36 place-items-center rounded-r-md">
                    ...
                    <div className = 'flex'>
                        ...
                        <span className='flex flex-col justify-center text-white w-35'>
                            ...
                            <span className='flex'>
                                <span>Tài Khoản</span>
                                <img className="w-6 h-6" src="https://salt.tikicdn.com/ts/upload/d7/d4/a8/34939af2da1ceeeae9f95b7485784233.png"></img>
                            </span>
                        </span>
                        <div className='flex items-center w-40 mx-5 '>
                            <div className='relative flex items-center mx-4'>
                                <img className="w-10 h-10" src="https://salt.tikicdn.com/ts/upload/40/44/6c/b80ad73e5e84aeb71c08e5d8d438eaa1.png"/>
                ...
                <div className='flex pb-4 justify-items-center'>
                    ...
                    <a className='absolute flex px-3 bg-blue-200 rounded-md right-40'>
                        <img className="mx-2" src="https://frontend.tikicdn.com/_desktop-next/static/img/icon-seller.svg"/>
